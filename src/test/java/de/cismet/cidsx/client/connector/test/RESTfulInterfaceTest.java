...
public class RESTfulInterfaceTest extends RESTfulInterfaceConnector {
    ...
    public RESTfulInterfaceTest() throws IOException 
    {
        ...
        final JsonNode node = JsonLoader.fromURL(RESTfulInterfaceConnector.class.getResource("metadata.json"));
    ...
    private final CidsBean insertDefaultCidsBean(JsonNode defaultCidsBeanNode)
            throws RemoteException {
